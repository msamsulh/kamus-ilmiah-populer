...
public class KamusIlmiahHelper {

    private static String KAMUS_ILMIAH = DatabaseHelper.TABLE_KAMUS;

    private Context context;
    private DatabaseHelper databaseHelper;
    private SQLiteDatabase database;

    public KamusIlmiahHelper(Context context) {
        this.context = context;
    }

    public KamusIlmiahHelper open() throws SQLException {
    ...
    public ArrayList<KamusIlmiah> getAllData() {
        KamusIlmiah kamusModel;
    ...
    public long insert(KamusIlmiah kamusModel) {
        String DATABASE_TABLE = KAMUS_ILMIAH;
    ...
    public void insertTransaction(ArrayList<KamusIlmiah> kamusModels) {
        String DATABASE_TABLE = KAMUS_ILMIAH;
    ...
    public void update(KamusIlmiah kamusModel) {
        String DATABASE_TABLE = KAMUS_ILMIAH;
